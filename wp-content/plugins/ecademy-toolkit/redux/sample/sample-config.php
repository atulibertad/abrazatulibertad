<?php
    ...
    $tabs = array(
        array(
            'id'      => 'redux-help-tab-1',
            'title'   => esc_html__( 'Theme Information 1', 'ecademy-toolkit' ),
            'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'ecademy-toolkit' )
        ),
        array(
            'id'      => 'redux-help-tab-2',
            'title'   => esc_html__( 'Theme Information 2', 'ecademy-toolkit' ),
            'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'ecademy-toolkit' )
        )
    );
    ...
    $content = esc_html__( '<p>This is the sidebar content, HTML is allowed.</p>', 'ecademy-toolkit' );
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
			'id'    => 'hide_blog_banner',
            'type'  => 'switch',
            'title' => esc_html__('Hide Blog Banner', 'ecademy-toolkit'),
            'default'   => '0'
        ),
        array(
			'id'    => 'hide_breadcrumb',
        ...
        array(
			'id'    => 'hide_author_info',
            'type'  => 'switch',
			'title' => esc_html__('Hide Author Info', 'ecademy-toolkit'),
            'default'   => '0',
        ),
    ) 
));
