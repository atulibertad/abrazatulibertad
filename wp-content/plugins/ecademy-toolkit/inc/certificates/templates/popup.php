...
<div id="certificate-popup">
	<?php learn_press_display_message( __( 'Congrats! You have achieved certificate.', 'ecademy-toolkit' ) ); ?>
	<?php learn_press_certificate_get_template( 'details.php', array( 'certificate' => $certificate ) ); ?>
    <a href="" data-tooltip="<?php esc_attr_e( 'Click or press ESC to close.', 'ecademy-toolkit' ); ?>"
       class="close-popup"></a>
</div>
