        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .get-instant-courses-content .sub-title, .view-all-courses-content .sub-title' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .get-instant-courses-content .sub-title, .view-all-courses-content .sub-title',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .get-instant-courses-content p, .view-all-courses-content p' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'scheme' => Scheme_Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .get-instant-courses-content p, .view-all-courses-content p',
                ]
	...
	protected function render() {
                ...
                <div class="container">
                    <div class="get-instant-courses-inner-area">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="get-instant-courses-image">
                                    ...
                                    <?php if( $settings['shape_image1']['url'] != '' ): ?>
                                        <div class="shape7" data-speed="0.02" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image1']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                                    <?php endif; ?>

                                    <?php if( $settings['shape_image2']['url'] != '' ): ?>
                                        <div class="shape6" data-speed="0.02" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image2']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php if( $settings['shape_image3']['url'] != '' ): ?>
                            <div class="shape5" data-speed="0.02" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image3']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                        <?php endif; ?>
                    </div>
                </div>
            </div> 
        <?php elseif( $settings['style'] == '2' ): ?>
            <div class="view-all-courses-area bg-fef8ef">
                ...
                <?php if( $settings['shape_image1']['url'] != '' ): ?>
                    <div class="shape1" data-speed="0.01" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image1']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                <?php endif; ?>
                
                <?php if( $settings['shape_image2']['url'] != '' ): ?>
                    <div class="shape9" data-speed="0.01" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image2']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                <?php endif; ?>
            </div>
            ...
            <div class="view-all-courses-area-two ptb-70 bg-fef8ef">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="view-all-courses-image">
                                ...
                                <?php if( $settings['shape_image1']['url'] != '' ): ?>
                                    <div class="shape11" data-speed="0.01" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image1']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                                <?php endif; ?>
                                
                                <?php if( $settings['shape_image2']['url'] != '' ): ?>
                                    <div class="shape12" data-speed="0.01" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image2']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <?php if( $settings['shape_image4']['url'] != '' ): ?>
                    <div class="shape1" data-speed="0.01" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image4']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                <?php endif; ?>
                
                <?php if( $settings['shape_image5']['url'] != '' ): ?>
                    <div class="shape9" data-speed="0.01" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image5']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
        <?php
...
Plugin::instance()->widgets_manager->register_widget_type( new eCademy_Instant_Courses_Area );