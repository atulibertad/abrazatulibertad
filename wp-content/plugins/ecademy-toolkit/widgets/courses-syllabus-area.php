                    ...
                    <?php endif; ?>
                        <div class="download-syllabus-form">
                            ...
                            <?php if( $settings['shape1']['url'] != '' ): ?>
                                <div class="syllabus-shape1"><img src="<?php echo esc_html( $settings['shape1']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image One', 'ecademy-toolkit' ); ?>"></div>
                            <?php endif; ?>

                            <?php if( $settings['shape2']['url'] != '' ): ?>
                                <div class="syllabus-shape2"><img src="<?php echo esc_url( $settings['shape2']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape2', 'ecademy-toolkit' ); ?>"></div>
                            <?php endif; ?>

                            <?php if( $settings['shape3']['url'] != '' ): ?>
                                <div class="syllabus-shape3"><img src="<?php echo esc_url( $settings['shape3']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image Three', 'ecademy-toolkit' ); ?>"></div>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new eCademy_Courses_Syllabus );