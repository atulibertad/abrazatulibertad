                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="program-list">
                                        ...
                                        if( $i == 1 || $i == 2 ):
                                            ...
                                            <div class="single-program-box">
                                                <?php if( $item['shape_image']['url'] != '' ): ?>
                                                    <div class="shape"><img src="<?php echo esc_url( $item['shape_image']['url'] ); ?>" alt="<?php echo esc_attr_e('Shape Image', 'ecademy-toolkit'); ?>"></div>
                                                <?php endif; ?>
                                                <?php if( $icon != '' ): ?>
                                                    <div class="icon">
                            ...
                            <?php if( $settings['shape1']['url'] != '' ): ?>
                                <div class="program-circle-shape"><img src="<?php echo esc_urL( $settings['shape1']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new eCademy_Program_Area );