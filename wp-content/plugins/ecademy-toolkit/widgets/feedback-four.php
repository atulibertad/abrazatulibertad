	...
	protected function render() {
        ...
        <div class="feedback-area bg-6dbbbd pt-100 pb-70">
            ...
            <?php if( $settings['shape_image1']['url'] != '' ): ?>
                <div class="kindergarten-shape13"><img src="<?php echo esc_url( $settings['shape_image1']['url'] ); ?>" alt="<?php echo esc_attr( $settings['title'] ); ?>"></div>
            <?php endif; ?>
            <?php if( $settings['shape_image2']['url'] != '' ): ?>
                <div class="kindergarten-shape14"><img src="<?php echo esc_url( $settings['shape_image2']['url'] ); ?>" alt="<?php echo esc_attr( $settings['title'] ); ?>"></div>
            <?php endif; ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Feedback_Four );