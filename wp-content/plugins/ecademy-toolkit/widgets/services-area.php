            ...
            <div class="container">
                ...
                <?php if( $settings['fimage']['url'] != '' ): ?>
                    <div class="kids-kite-image">
                        <img src="<?php echo esc_url( $settings['fimage']['url'] ); ?>" alt="image">
                    </div>
                <?php endif; ?>
            </div>

            <?php if( $settings['shape_image1']['url'] != '' ): ?>
                <div class="kindergarten-shape9"><img src="<?php echo esc_url( $settings['shape_image1']['url'] ); ?>" alt="<?php echo esc_attr( $settings['title'] ); ?>"></div>
            <?php endif; ?>
            <?php if( $settings['shape_image2']['url'] != '' ): ?>
                <div class="kindergarten-shape10"><img src="<?php echo esc_url( $settings['shape_image2']['url'] ); ?>" alt="<?php echo esc_attr( $settings['title'] ); ?>"></div>
            <?php endif; ?>
        </div>  
        <?php
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Services_Area );