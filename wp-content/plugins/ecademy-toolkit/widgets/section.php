            ...
            <?php elseif( $settings['style'] == '2' ): 
                ...
                <div class="premium-access-area ptb-100">
                    ...
                    <?php if( $settings['shape_image1']['url'] != '' ): ?>
                        <div class="shape3"><img src="<?php echo esc_url( $settings['shape_image1']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                    <?php endif; ?>
                
                    <?php if( $settings['shape_image2']['url'] != '' ): ?>
                        <div class="shape4"><img src="<?php echo esc_url( $settings['shape_image2']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                    <?php endif; ?>
                    <?php if( $settings['shape_image2']['url'] != '' ): ?>
                        <div class="shape8"><img src="<?php echo esc_url( $settings['shape_image3']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                    <?php endif; ?>
                </div>           
            <?php endif; ?>   
        <?php
...
Plugin::instance()->widgets_manager->register_widget_type( new eCademy_Section );