                            ...
                            <div class="single-pricing-box">
                                <div class="pricing-header">
                                    <?php if( $table['image']['url'] != '' ): ?>
                                        <img src="<?php echo esc_url( $table['image']['url']); ?>" alt="image">
                                    <?php endif; ?>
                                ...
                                <?php if( $settings['shape1']['url'] != '' ): ?>
                                    <div class="pricing-shape1"><img src="<?php  echo esc_url( $settings['shape1']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image One', 'ecademy-toolkit' ); ?>"></div>
                                <?php endif; ?>

                                <?php if( $settings['shape2']['url'] != '' ): ?>
                                    <div class="pricing-shape2"><img src="<?php  echo esc_url( $settings['shape2']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image One', 'ecademy-toolkit' ); ?>"></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
