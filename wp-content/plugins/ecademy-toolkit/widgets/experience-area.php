        ...
        <?php elseif( $settings['style'] == '2' ): ?>
            <div class="experience-area ptb-100">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="experience-content">
                                <?php if( $settings['shape1']['url'] != '' ): ?>
                                    <div class="shape"><img src="<?php echo esc_url( $settings['shape1']['url'] ); ?>" alt="<?php echo esc_attr_e('Shape Image', 'ecademy-toolkit') ?>"></div>
                                <?php endif; ?>
                                <span class="sub-title"><?php echo esc_html( $settings['top_title'] ); ?></span>
                                <<?php echo esc_attr( $settings['title_tag'] ); ?> <?php echo $this-> get_render_attribute_string('title'); ?>><?php echo esc_html( $settings['title'] ); ?></<?php echo esc_attr( $settings['title_tag'] ); ?>>
                                <p <?php echo $this-> get_render_attribute_string('content'); ?>><?php echo wp_kses_post( $settings['content'] ); ?></p>
                ...
                <?php if( $settings['shape2']['url'] != '' ): ?>
                    <div class="experience-shape1"><img src="<?php echo esc_url( $settings['shape2']['url'] ); ?>" alt="<?php echo esc_attr_e('Shape Image', 'ecademy-toolkit') ?>"></div>
                <?php endif; ?>
                <?php if( $settings['shape3']['url'] != '' ): ?>
                    <div class="experience-shape2"><img src="<?php echo esc_url( $settings['shape3']['url'] ); ?>" alt="<?php echo esc_attr_e('Shape Image', 'ecademy-toolkit') ?>"></div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
        <?php
...
Plugin::instance()->widgets_manager->register_widget_type( new eCademy_ExperienceArea  );