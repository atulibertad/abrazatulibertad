	...
	protected function render() {
        ...
        <?php if( $settings['style'] == '1' ): ?>
            <div class="about-area bg-fef8ef ptb-100">
                ...
                <?php if( $settings['shape_image1']['url'] != '' ): ?>
                    <div class="shape1" data-speed="0.06" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image1']['url'] ); ?>" alt="<?php echo esc_attr__( 'About Us' ); ?>"></div>
                <?php endif; ?>

                <?php if( $settings['shape_image2']['url'] != '' ): ?>
                    <div class="shape2" data-speed="0.06" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image2']['url'] ); ?>" alt="<?php echo esc_attr__( 'About Us' ); ?>"></div>
                <?php endif; ?>

                <?php if( $settings['shape_image3']['url'] != '' ): ?>
                    <div class="shape3" data-speed="0.06" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image3']['url'] ); ?>" alt="<?php echo esc_attr__( 'About Us' ); ?>"></div>
                <?php endif; ?>

                <?php if( $settings['shape_image4']['url'] != '' ): ?>
                    <div class="shape4" data-speed="0.06" data-revert="true"><img src="<?php echo esc_url( $settings['shape_image4']['url'] ); ?>" alt="<?php echo esc_attr__( 'About Us' ); ?>"></div>
                <?php endif; ?>
            </div>   
        ...
        <?php elseif( $settings['style'] == '3' ): ?>
            <div class="about-area ptb-100">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-12">
                            <div class="kindergarten-about-image">
                                ...
                                <?php if( $settings['shape_image1']['url'] != '' ): ?>
                                    <div class="shape"><img src="<?php echo esc_url( $settings['shape_image1']['url'] ); ?>" alt="<?php echo esc_attr_e( 'About Us' ); ?>"></div>
                                <?php endif; ?>
                            </div>
                        </div>
                ...
                <?php if( $settings['shape_image2']['url'] != '' ): ?>
                    <div class="kindergarten-shape7"><img src="<?php echo esc_url( $settings['shape_image2']['url'] ); ?>" alt="<?php echo esc_attr_e( 'Shape Image' ); ?>"></div>
                <?php endif; ?>
                <?php if( $settings['shape_image3']['url'] != '' ): ?>
                    <div class="kindergarten-shape8"><img src="<?php echo esc_url( $settings['shape_image3']['url'] ); ?>" alt="<?php echo esc_attr_e( 'Shape Image' ); ?>"></div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
        <?php
...
Plugin::instance()->widgets_manager->register_widget_type( new eCademy_Distance_Learning );