	...
	protected function render() {
        ...
        <?php elseif( $settings['style'] == '2' ): ?>
            ...
            <?php if( $settings['shape1']['url'] != '' ): ?>
                <div class="shape2" data-speed="0.06" data-revert="true"><img src="<?php echo esc_url( $settings['shape1']['url'] ); ?>" alt="<?php echo esc_attr__('Shape Image', 'ecademy-toolkit') ?>"></div>
            <?php endif; ?>
            <?php if( $settings['shape2']['url'] != '' ): ?>
                <div class="shape3" data-speed="0.06" data-revert="true"><img src="<?php echo esc_url( $settings['shape2']['url'] ); ?>" alt="<?php echo esc_attr__('Shape Image', 'ecademy-toolkit') ?>"></div>
            <?php endif; ?>
            <?php if( $settings['shape3']['url'] != '' ): ?>
                <div class="shape4" data-speed="0.06" data-revert="true"><img src="<?php echo esc_url( $settings['shape3']['url'] ); ?>" alt="<?php echo esc_attr__('Shape Image', 'ecademy-toolkit') ?>"></div>
            <?php endif; ?>
            <?php if( $settings['shape4']['url'] != '' ): ?>
                <div class="shape9" data-speed="0.06" data-revert="true"><img src="<?php echo esc_url( $settings['shape4']['url'] ); ?>" alt="<?php echo esc_attr__('Shape Image', 'ecademy-toolkit') ?>"></div>
            <?php endif; ?>
        <?php endif; ?>
        <?php
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new eCademy_Overview_Area  );