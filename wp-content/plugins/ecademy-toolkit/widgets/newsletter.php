            ...
            $this->add_group_control(
               Group_Control_Background::get_type(),
                [
                    ...
                    'selector' => '{{WRAPPER}} .subscribe-area-two',
                    'condition' => [
                        'select_style' => ['3', '4'],
                    ]
                ]
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .subscribe-content .sub-title' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .subscribe-content .sub-title',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .subscribe-content h2, .subscribe-content h3, .subscribe-content h4, .subscribe-content h5, .subscribe-content h5, .subscribe-content h6, .subscribe-content h1, .subscribe-content.text-left h2' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'scheme' => Scheme_Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .subscribe-content h2, .subscribe-content h3, .subscribe-content h4, .subscribe-content h5, .subscribe-content h5, .subscribe-content h6, .subscribe-content h1, .subscribe-content.text-left h2',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .subscribe-content p, .subscribe-content.text-left p' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            <?php if( $settings['select_mod'] == 'mailchimp' ): ?>
                <div class="subscribe-area bg-f9f9f9 ptb-100">
                    ...
                    <?php if( $settings['shape1']['url'] != '' ): ?>
                        <div class="shape4"><img src="<?php echo esc_url( $settings['shape1']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                    <?php endif; ?>

                    <?php if( $settings['shape2']['url'] != '' ): ?>
                        <div class="shape13"><img src="<?php echo esc_url( $settings['shape2']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                    <?php endif; ?>

                    <?php if( $settings['shape3']['url'] != '' ): ?>
                        <div class="shape14"><img src="<?php echo esc_url( $settings['shape3']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                    <?php endif; ?>

                    <?php if( $settings['shape4']['url'] != '' ): ?>
                        <div class="shape15"><img src="<?php echo esc_url( $settings['shape4']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                    <?php endif; ?>
                </div>
                <script>
                    ;(function($){
        ...
        <?php elseif( $settings['select_style'] == '4' ): ?>
            <?php if( $settings['select_mod'] == 'mailchimp' ): ?>
                <div class="subscribe-area bg-eee8df ptb-70">
                    ...
                    <?php if( $settings['shape2']['url'] != '' ): ?>
                        <div class="kindergarten-shape19"><img src="<?php echo esc_url( $settings['shape1']['url'] ); ?>" alt="<?php echo esc_attr_e( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                    <?php endif; ?>   
                    
                    <?php if( $settings['shape2']['url'] != '' ): ?>
                        <div class="kindergarten-shape20"><img src="<?php echo esc_url( $settings['shape2']['url'] ); ?>" alt="<?php echo esc_attr_e( 'Shape Image', 'ecademy-toolkit' ); ?>"></div>
                    <?php endif; ?>   
                </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new eCademy_Newsletter );