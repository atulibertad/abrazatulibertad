...
class eCademy_Courses_Filter extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Courses Filter', 'ecademy-toolkit' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
			'course_section',
			[
				'label' => esc_html__( 'Courses Filter', 'ecademy-toolkit' ),
        ...
        $this->add_control(
			'count',
			[
				'label' => esc_html__( 'Count', 'ecademy-toolkit' ),
	...
	protected function render() {
        ...
        ?>
            ...
            <div class="container">
                ...
                <div class="shorting">
                    <div class="row">
                        ...
                        ?>
                            <div class="col-lg-4 col-md-6 mix <?php echo join( ' ', $output ); ?>">
            ...
            <?php if( $settings['shape']['url'] != '' ): ?>
                <div class="shape16"><img src="<?php echo esc_url($settings['shape']['url']); ?>" alt="<?php echo esc_attr__( 'Shape', 'ecademy-toolkit' ); ?>"></div>
            <?php endif; ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new eCademy_Courses_Filter );