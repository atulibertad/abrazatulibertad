                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="health-coaching-inner">
                                ...
                                <div class="feedback-quote">
                                    ...
                                    <?php if( $settings['shape_image1']['url'] != '' ): ?>
                                        <div class="object1"><img src="<?php echo esc_url( $settings['shape_image1']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image Three', 'ecademy-toolkit' ); ?>"></div>
                                    <?php endif; ?>
                                    <?php if( $settings['shape_image2']['url'] != '' ): ?>
                                        <div class="object2"><img src="<?php echo esc_url( $settings['shape_image2']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image Three', 'ecademy-toolkit' ); ?>"></div>
                                    <?php endif; ?>
                                    <?php if( $settings['shape_image3']['url'] != '' ): ?>
                                        <div class="object3"><img src="<?php echo esc_url( $settings['shape_image3']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image Three', 'ecademy-toolkit' ); ?>"></div>
                                    <?php endif; ?>
                                    <?php if( $settings['shape_image4']['url'] != '' ): ?>
                                        <div class="object4"><img src="<?php echo esc_url( $settings['shape_image4']['url'] ); ?>" alt="<?php echo esc_attr__( 'Shape Image Three', 'ecademy-toolkit' ); ?>"></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new eCademy_Single_Feedback );