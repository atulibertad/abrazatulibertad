...
<div class="page-title-area" <?php echo wp_kses_post( $background_image ); ?>>
    <div class="container">
        <div class="page-title-content">
            ...
            <?php if( $is_breadcrumb == '1' ): ?>
                <?php if( $is_breadcrumb == '1' ): ?>
                    <?php if( $banner_alignment != '1' ): ?><div class="text-left"><?php endif; ?>
    ...
    <?php if( $is_shape_image == '1' && isset( $ecademy_opt['shape_image1']['url'] )): ?>
        <?php if( $ecademy_opt['shape_image1']['url'] != '' ): ?>
            <div class="shape9"><img src="<?php echo esc_url( $ecademy_opt['shape_image1']['url'] ); ?>" alt="<?php esc_attr_e( 'Shape Image One', 'ecademy' ); ?>"></div>
        <?php endif; ?>
    <?php endif; ?>
</div>