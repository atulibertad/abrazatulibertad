 ...
 *
 * This template can be overridden by copying it to ecademy/learnpress/checkout/review-order.php.
 *
 * @author  EnvyTheme
...
<h4><?php esc_html_e( 'Your order', 'ecademy' ) ?></h4>
...
<div class="table-responsive">
    <table class="learn-press-checkout-review-order-table lp-list-table">
        ...
        <tr>
            ...
            <th class="course-name"><?php esc_html_e( 'Course', 'ecademy' ); ?></th>
            <th class="course-total"><?php esc_html_e( 'Total', 'ecademy' ); ?></th>
        ...
        <tr class="cart-subtotal">
            ...
            <th><?php esc_html_e( 'Subtotal', 'ecademy' ); ?></th>
            <td><?php echo esc_html( $cart->get_subtotal() ); ?></td>
        ...
        <tr class="order-total">
            ...
            <td><?php echo esc_html( $cart->get_total() ); ?></td>
